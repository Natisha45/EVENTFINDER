...
function displayEvents(){
    ...
    if (!listofevents) return; // Skip if container doesn't exist
    ...
    nonFeaturedEvents.forEach(function(event){
        console.log("Creating card for:", event.title);
...
function displayFeaturedEvents(){
    ...
    if (!featuredContainer) return; // Skip if container doesn't exist
